                ...
                <div className='mt-2 flex gap-2'>
                  {Object.entries(totalPorFase)
                    ...
                    .map(([fase, qtde]) => (
                      ...
                      >
                        <p className='text-[10px] text-zinc-500'>Fase {fase}</p>
              ...
              <div className='flex flex-wrap items-center justify-between gap-2 border-b border-zinc-200 bg-zinc-50/60 px-4 py-2'>
                ...
                <div className='flex items-center gap-2'>
                  <select
                    value={bulkStatus}
                    onChange={(e) =>
                      setBulkStatus(e.target.value as Lead['status'])
                    }
                  ...
                  <tr>
                    <th className='px-4 py-2'>
                      <input
                        ...
                        onChange={(e) =>
                          handleSelectAllDisplayed(e.target.checked)
                        }
                  ...
                  {displayedLeads.map((lead) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className='px-4 py-2'>{lead.tentativas_no_dia}</td>
